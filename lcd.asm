...
.equ clock = 16000000
.def temp = R16
.equ linha1 = 0x03 ;endereço da linha 1 do display
.equ linha2 = 0x44 ;endereço da linha 2 do display
;instruções do lcd
...
; display the first line of information
    ldi     ZH, high(string1)        ; point to the information that is to be displayed
    ldi     ZL, low(string1)
    ldi     temp, linha1               ; point to where the information should be displayed
    rcall    escrevertexto
; display the second line of information
    ldi     ZH, high(string2)       ; point to the information that is to be displayed
    ldi     ZL, low(string2)
    ldi     temp, linha2               ; point to where the information should be displayed
    rcall    escrevertexto
...
; Set up the RS and E lines for the 'lcd_write_4' subroutine.
    cbi     PORTB, PB0         ; select the Instruction Register (RS low)
    cbi     PORTB, PB1           ; make sure E is initially low
...
escrevercaractere:
    sbi     PORTB, 0        ; select the Data Register (RS high)
    cbi     PORTB, 1          ; make sure E is initially low
...
lcd_write_instruction_4d:
    cbi     PORTB, 0         ; select the Instruction Register (RS low)
    cbi     PORTB, 1           ; make sure E is initially low
